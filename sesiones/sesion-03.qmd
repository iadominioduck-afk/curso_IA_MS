...
<figure style="margin:1.4rem 0;">
  <svg viewBox="0 0 580 295" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:560px;display:block;margin:0 auto;" role="img" aria-label="Árbol de decisión para clasificar spam en tres preguntas">
    <defs>
  ...
  <figcaption style="text-align:center;font-size:0.78rem;color:#94a3b8;margin-top:0.5rem;">El árbol aprendió estas tres preguntas solo — nadie las programó a mano.</figcaption>
</figure>
```
