...
## Texto: Robótica e IA en el Mundo Físico
...
### Recursos extra: videos y simulaciones para seguir aprendiendo de robótica
...
1. **La robótica tiene consecuencias en el mundo físico.** Por eso un error es más visibles y más costosos que en otras aplicaciones de la IA.

2. **La autonomía siempre tiene límites.** Un sistema responsable no solo hace cosas; también sabe en qué situaciones no debería actuar solo.

3. **La simulación es parte del aprendizaje y de la seguridad.** Muchos robots modernos aprenden primero en entornos virtuales antes de salir al mundo físico.

4. **No pienses en construit robots, piensa en qué problemas pueden ser solucionados con robots.** Y cuando ese problema ocurre en un entorno cambiante, la IA puede ser parte de la solución.
:::
