...
<div class="central-idea">
  ...
  <p class="central-idea-text">La IA puede ser muy útil para estudiar matemáticas si distingues tres tareas distintas: entender, verificar y practicar. Un asistente conversacional puede ayudarte a comprender; herramientas exactas sirven para comprobar; y el aprendizaje real ocurre cuando después practicas sin ayuda.</p>
</div>
```
