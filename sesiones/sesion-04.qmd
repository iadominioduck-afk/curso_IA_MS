---
title: "IA Generativa: ChatGPT, Gemini, Perplexity"
format:
  html:
    toc: true
    toc-depth: 2
...
<div class="sesion-banner">
  ...
  <div class="sesion-progress-wrap">
    ...
    <span class="sesion-progress-label">4 de 12</span>
  </div>
...
<div class="video-capsule">
  <iframe src="https://share.descript.com/embed/0U5xGeXtXPm" width="640" height="360" frameborder="0" allowfullscreen></iframe>
</div>
```
...
```{=html}
<div class="video-capsule">
  <iframe src="https://share.descript.com/embed/bvvLW1HJ7A7" width="640" height="360" frameborder="0" allowfullscreen></iframe>
</div>
```
...
<div class="diffusion-card">
  <img src="../assets/sesion-04/diffusion-sequence.svg" alt="Infografía de tres pasos que muestra cómo una IA de imágenes pasa de ruido inicial a una imagen final guiada por un prompt" class="diffusion-diagram">
...
<nav class="sesion-nav">
  ...
  <div class="sesion-nav-center">
    ...
    <span class="sesion-nav-progress">Sesión 4 de 12</span>
  </div>
  <a href="sesion-05.html" class="sesion-nav-btn next">
    <span class="nav-label">Siguiente →</span>
    <span class="nav-title">Ética y problemas reales</span>
  </a>
</nav>
```
